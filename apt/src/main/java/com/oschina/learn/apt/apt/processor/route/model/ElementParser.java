package com.oschina.learn.apt.apt.processor.route.model;


import com.oschina.learn.apt.apt.processor.route.ParcelException;
import com.oschina.learn.apt.apt.processor.route.factory.ClassFactory;
...
public class ElementParser {
    ...
    /**
     * Parse and check out all of fields that was annotated by {@link com.oschina.learn.lib.apt.route.Arg}
     */
    ...
    /**
     * get all of fields that be annotated by {@link com.oschina.learn.lib.apt.route.Arg} on itself and parent class
     * @param type The class to check
     * @return all of field elements that be annotated by {@link com.oschina.learn.lib.apt.route.Arg}
     */
