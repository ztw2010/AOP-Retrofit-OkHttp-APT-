...
public class BaseAdapterHelper {
    ...
    protected BaseAdapterHelper(Context context, ViewGroup parent, int layoutId, int position) {
        ...
        if (null != com.app.lib.widget.Adapter.singleton &&
                null != com.app.lib.widget.Adapter.singleton.getImageLoad()) {
            mImageLoad = com.app.lib.widget.Adapter.singleton.getImageLoad();
        }
    }
