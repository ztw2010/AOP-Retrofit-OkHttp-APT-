package com.oschina.learn.aop;

import android.text.TextUtils;
import android.util.Log;

import com.oschina.learn.utils.LogUtils;
import com.oschina.learn.utils.MemoryCacheManager;
...
public class MemoryCacheAspect {
    ...
    @Pointcut("execution(@com.oschina.learn.lib.aspect.MemoryCache * *(..))")//方法切入点
    public void methodAnnotated() {
    }

    @Around("methodAnnotated()")//在连接点进行方法替换
    public Object aroundJoinPoint(ProceedingJoinPoint joinPoint) throws Throwable {
        Log.d("MMM", "-----aroundJoinPoint excute");
