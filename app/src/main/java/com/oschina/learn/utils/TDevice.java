...
public class TDevice {
    ...
    public static boolean isPortrait() {
        return App.getAppContext().getResources().getConfiguration()
    ...
    public static boolean isTablet() {
        int s = App.getAppContext().getResources().getConfiguration().screenLayout;
    ...
    public static int getVersionCode() {
        return getVersionCode(App.getAppContext().getPackageName());
    }
